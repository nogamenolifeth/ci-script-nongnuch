...
class Welcome extends CI_Controller {
		...
		public function minimart()
	{
		...
		<meta name="keywords" content="js minifier,ลดขนาดไฟล์,บีบอัดไฟล์,javascript" />
		<style>#outputtitle,#output,#statstitle,#stats{display:none;}</style>';
		$data0['content_view'] = 'minimart/index';
		$data1['content_view'] = 'minimart/sale';
		$data2['content_view'] = 'minimart/stock';
		$data3['content_view'] = 'minimart/report';
		$data4['content_view'] = 'minimart/about';
		$data5['content_view'] = 'minimart/addproduct';
$this->load->view('default',$data0);
$this->load->view('default',$data1);
$this->load->view('default',$data2);
$this->load->view('default',$data3);
$this->load->view('default',$data4);
	}
