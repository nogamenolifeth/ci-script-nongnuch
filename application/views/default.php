...
echo css_asset('bootstrap.css');
//echo css_asset('bootstrap.min.css');
echo css_asset('bootstrap.theme.css');
//echo css_asset('bootstrap.theme.min.css');
		  ...
		  ?>
            <li class="<?php echo($this->uri->segment(1)=='profile'?'active ':''); ?>dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php echo site_url('forum/web'); ?>">ตั้งกระทู้ใหม่</a></li>
                <li><a href="<?php echo site_url('profile/users/'.$this->input->cookie('user_id')); ?>">กระทู้ของคุณ</a></li>
                 <li><a href="<?php echo site_url('minimart'); ?>">ระบบสินค้าคงคลัง</a></li>
               <li class="divider"></li>
...
<div class="container">
    ...
    <hr />
    <footer>
      <p>&copy;พบสุขคอมพิวเตอร์ 2016 | หน้านี้ใช้เวลาในการสร้าง <strong>{elapsed_time}</strong> วินาที</p>
    </footer>
</div>
</div>
</body>
