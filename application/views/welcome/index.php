<br><br><br><div class="thumbnail">
    ...
    <div id="index_download">
        ...
        <span>เวอร์ชั่นปัจจุบัน 3.0.5</span>
        </a>
    </div>
</div>
<header>
	<h2>ยินดีต้อนรับสู่สังคมผู้ใช้ CodeIgniter</h2>
    <p class="content">หลังจากที่ห่างหายไปพักใหญ่ พบสุขคอมพิวเตอร์ ก็ได้กลับมาเดินหน้าอีกครั้ง คราวนี้เตรียมความพร้อมมาเต็มที่ ตอนที่กำลังเริ่มทำเว็บก็กำลังคิดอยู่ว่าจะทำเว็บยังไงดี ไม่รู้จะทำเว็บด้วยอะไรดี คิดไปคิดมา เราเป็น พบสุขคอมพิวเตอร์ ทั้งที หากเว็บเราเองทำด้วยเว็บสำเร็จรูปหรือ CMS ทั่วไปคงดูไม่ดีแน่ ก็เลยตัดสินใจ เขียนเว็บเองเลย ยังไงเราก็ถนัดใช้ codeigniter อยู่แล้วนี่นา อย่านี้ต้องโชวฝีมือกันหน่อย ว่าแล้วก็เริ่มเลย</p>
